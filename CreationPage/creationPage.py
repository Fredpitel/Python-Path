...
class CreationPage:
	def __init__(self, controller, parent):
		...
		self.creationPage = ttk.Frame(parent, relief=RIDGE, padding=10)
		...
		# Left Frame
		#
		self.summaryFrame = ttk.Frame(self.creationPage, relief=RAISED, padding=10)
		...
		self.racesMenu = OptionMenu(self.summaryFrame, self.controller.race, *self.controller.RACES)
		...
		self.favClassMenu = OptionMenu(self.summaryFrame, self.controller.favClass, *self.controller.CLASSES)
		...
		# Errors
		self.controller.errorFrame = ttk.Frame(self.creationPage, relief=SUNKEN, padding=10)
		...
		# Center Frame
		#
		self.statFrame = ttk.Frame(self.creationPage, relief=RAISED, padding=10)
		...
		Label(self.abilityFrame, textvariable=self.controller.getModifiableValue("str"), bg="white", width=2).grid(row=1, column=0, sticky="E", padx=5)
		...
		Label(self.abilityFrame, textvariable=self.controller.getModifiableValue("dex"), bg="white", width=2).grid(row=1, column=2, sticky="E", padx=5)
		...
		Label(self.abilityFrame, textvariable=self.controller.getModifiableValue("con"), bg="white", width=2).grid(row=1, column=4, sticky="E", padx=5)
		...
		Label(self.abilityFrame, textvariable=self.controller.getModifiableValue("int"), bg="white", width=2).grid(row=3, column=0, sticky="E", padx=5)
		...
		Label(self.abilityFrame, textvariable=self.controller.getModifiableValue("wis"), bg="white", width=2).grid(row=3, column=2, sticky="E", padx=5)
		...
		Label(self.abilityFrame, textvariable=self.controller.getModifiableValue("cha"), bg="white", width=2).grid(row=3, column=4, sticky="E", padx=5)
		...
		# Right Frame
		#
		self.classFrame = ttk.Frame(self.creationPage, relief=RAISED, padding=10)
		...
		# Total HP
		self.hpFrame = ttk.Frame(self.creationPage, relief=RAISED, padding=10)
		...
		Label(self.hpFrame, textvariable=self.controller.getModifiableValue("hp")).grid(row=1, column=1)
